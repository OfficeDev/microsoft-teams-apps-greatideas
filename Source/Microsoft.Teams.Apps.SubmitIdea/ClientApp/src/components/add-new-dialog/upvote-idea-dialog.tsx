...
class UpvoteIdeaDialogContent extends React.Component<
  IIdeaDialogContentProps,
  IIdeaDialogContentState
> {
  localize: TFunction;
  teamId = "";
  ...
  componentDidMount() {
    ...
    microsoftTeams.getContext((context: microsoftTeams.Context) => {
      ...
      this.getIdea(
        this.props.cardDetails?.createdByObjectId!,
        this.props.cardDetails?.ideaId
      );
    });
  }
      ...
      return (
        <Provider className="dialog-provider-wrapper">
          <Flex>
              ...
              <ItemLayout
                ...
                media={
                  <Image
                    ...
                    src="/Artifacts/applicationLogo.png"
                  />
                }
                header={
                  <Text
                    content={this.localize("dialogTitleAppName")}
                    weight="bold"
                  />
                }
                content={
                  <Text
                    content={this.localize("viewIdeaTitle")}
                    weight="semibold"
                    size="small"
                  />
                }
            ...
            <CloseIcon
              className="icon-hover close-icon"
              onClick={() => this.props.changeDialogOpenState(false)}
            />
          </Flex>
          <Flex>
            <div className="dialog-body">
              {this.state.idea && (
                <Flex column gap="gap.small">
                    ...
                    <Flex.Item align="end" push>
                      <Flex column>
                        <Text
                          size="largest"
                          weight="bold"
                          content={this.state.idea.totalVotes}
                        />
                        <Text
                          size="small"
                          content={this.localize("UpvotesText")}
                        />
                      </Flex>
                    </Flex.Item>
                  </Flex>
                  <Flex column>
                    <Text
                      content={this.localize("SynopsisText")}
                      weight="bold"
                    />
                    <Text
                      className="word-break"
          ...
          <Flex className="dialog-footer-wrapper">
            <Flex
              gap="gap.smaller"
              className="dialog-footer input-fields-margin-between-add-post"
            >
              <div></div>
              <Flex.Item push>
                <Button
                  content={
                    this.props.cardDetails.isVotedByUser === true
                      ? this.localize("unlikeButtonText")
                      : this.localize("UpvoteButtonText")
                  }
                  //Ashish: Enhancement for : Great ideas app needs to disable voting once an app has been approved.
                  //added disbled condition.
                  disabled={
                    this.props.cardDetails.status === ApprovalStatus.Approved
                      ? true
                      : false
                  }
                  primary
